...
data <- read.csv("https://github.com/JLBallin/projects/blob/main/Temperature_Predictions/external_training_data.csv")
...
# No ARIMA's going to fit this super well, but this order seems as reasonable as any other.
